...
import com.antoniolage.cleantmdb.databinding.ActivityTvShowBinding
import com.antoniolage.cleantmdb.presentation.di.Injector
import com.antoniolage.cleantmdb.presentation.tvshows.TvAdapter
...
class TVShowActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        (application as Injector).tvShowSubComponent()
            .inject(this)
